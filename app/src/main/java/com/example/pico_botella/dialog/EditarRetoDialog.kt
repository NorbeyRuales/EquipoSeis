...
class EditarRetoDialog(private val reto: Reto, private val parentFragment: RetosFragment) : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        etDescripcion.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (hasText) {
                    ...
                    btnSave.backgroundTintList = ColorStateList.valueOf(android.graphics.Color.GRAY)
                }
            }
        ...
        btnSave.setOnClickListener {
            ...
            if (desc.isNotEmpty()) {
                reto.descripcion = desc
                parentFragment.viewModel.update(reto)
                dismiss()
            }
        }
